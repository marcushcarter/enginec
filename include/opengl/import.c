...
//     VertexVector verts;
//     VertexVector_Copy(vertices, verticesCount, &verts);

//     GLuintVector inds;
//     GLuintVector_Copy(indices, indicesCount, &inds);

//     TextureVector texs;
//     TextureVector_Copy(textures, 1, &texs);

//     mesh = Mesh_Init(&verts, &inds, &texs);

//     // char buffer[256];
//     // // snprintf(buffer, sizeof(buffer), "", 0);

//     // FILE* file2 = fopen("src/vert.c", "w");
//     // if (file == NULL) {
//     //     perror("Failed to open file");
//     //     return mesh;
//     // }

//     // fputs("Vertex modelVertices[] = {\n", file2);
//     // for (int i = 0; i < verticesCount; i++) {

//     //     snprintf(
//     //         buffer, sizeof(buffer), 
//     //         "\t{ { %f, %f, %f }, { %f, %f, %f }, { %f, %f, %f }, { %f, %f } },\n", 
//     //         vertices[i].position[0], vertices[i].position[1], vertices[i].position[2], vertices[i].normal[0], vertices[i].normal[1], vertices[i].normal[2], 1.0f, 1.0f, 1.0f, vertices[i].texUV[0], vertices[i].texUV[1]
//     //     );
